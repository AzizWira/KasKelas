...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <span class="w3-hide-small"><h1><b><font face="Andalus"><li class="fa fa-home"> KAS KELAS</li></font></b></h1></span>
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    <h4 style=>BAYARLAH UANG KAS TEPAT WAKTU !!</h4>
    <!-- Pricing Tables -->
